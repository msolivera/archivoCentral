            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="serieDocumental/edit/{{$serie->id}}" class="btn btn-xs btn-info"><i class="fa fa-light fa-pen"></i></a>  
                  <form method="POST" action="{{route('serieDocumental.destroy',$serie->id)}}" style="display: inline"> {{ csrf_field() }} {{method_field('DELETE')}}
...
<div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <form method="POST" action="{{route('serieDocumental.store')}}">
    {{ csrf_field() }}
