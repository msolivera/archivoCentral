        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-4">
                <a href="{{route('ciudades.crear')}}" style="float: right;" class="btn btn-block btn-outline-primary col-6">Nuevo</a>
              </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <a href="ciudad/edit/{{$ciudad->id}}" class="btn btn-xs btn-info"><i class="fa fa-light fa-pen"></i></a>  
                  <form method="POST" action="{{route('ciudad.destroy',$ciudad->id)}}" style="display: inline"> {{ csrf_field() }} {{method_field('DELETE')}}
