                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-8">
                                    <h3 class="card-title">Fichas Impersonales • Ver</h3>
                                </div>
                                <div class="col-4">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="card" id="impersonal" style="display: none;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6" style="display: inline-block;">
                                                            ...
                                                            <div
                                                                ...
                                                                <input name="nombre" type="imput" class="form-control"
