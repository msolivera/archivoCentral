            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="parentesco/edit/{{$parentesco->id}}" class="btn btn-xs btn-info"><i class="fa fa-light fa-pen"></i></a>  
                  <form method="POST" action="{{route('parentesco.destroy',$parentesco->id)}}" style="display: inline"> {{ csrf_field() }} {{method_field('DELETE')}}
