        ...
        <ol class="breadcrumb">
            <div class="col-md-6">
                <h4> Fichas Personales
                    @switch($tipo)
                        @case('fichaPer')
                            <small>• Relacionar fichasPersonales Personales {{ $fichaPerTitular->primerNombre }}
                                {{ $fichaPerTitular->primerApellido }}</small>

                            @default
                                <small>• Relacionar fichasPersonales Personales</small>
                            </h4>
                        </div>
                        <div class="col-md-6" style="float: left;">
                            @switch($tipo)
                                @case('fichaPer')
                                    ...
                                    @default
                                        <a style="float: right;"href="#" class="btn btn-block btn-outline-primary">Atrás</a>
                                    </div>
                                                ...
                                                <table id="parientesTable" class="table table-bordered table-striped ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($fichasParientePer as $fichaPerPariente)
                                                            <tr>
                                                                <form method="POST"
                                                                    action="{{ route('parientes.store', $fichaPerTitular->id) }}"
