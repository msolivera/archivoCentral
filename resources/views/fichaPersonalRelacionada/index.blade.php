        ...
        <ol class="breadcrumb">
            <div class="col-md-6">
                <h4> Fichas Personales
                    @switch($fichaPerTitular->tipo)
                        @case('fichaPersonal')
                            <small>• Relacionar Con: {{ $fichaPerTitular->primerNombre }}
                    ...
                    <div class="row">
                        ...
                        <table id="parientesTable" class="table table-bordered table-striped ">
                            ...
                            <tbody>
                                ...
                                @foreach ($fichasPerRel as $fichaRelacionada)
                                    <tr>
                                        <form method="POST"
                                            href="/fichaPersonalRelacionada/{{ $fichaPerTitular->id }}/{{ $fichaPerTitular->tipo }}"
                                            ...
                                            <td>{{ $fichaRelacionada->primerNombre }}</td>
                                            <td>{{ $fichaRelacionada->segundoNombre }}</td>
                                            <td>{{ $fichaRelacionada->primerApellido }}</td>
                                            <td>{{ $fichaRelacionada->segundoApellido }}</td>
