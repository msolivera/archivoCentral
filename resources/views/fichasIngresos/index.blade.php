        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <button style="float: right;" class="btn btn-block btn-outline-primary col-6"
                                        id="mostrarNuevoIngreso">Nuevo Ingreso</button>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="card" id="ingreso" style="display: none;">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6" style="display: inline-block;">
                                                        <div
                                                            ...
                                                            <input name="numeroPaquete" type="imput" class="form-control"
                                                                id="numeroPaquete" placeholder="..."
                                                        ...
                                                        <div
                                                            ...
                                                            <input name="primerNombre" type="imput" class="form-control"
                                                        ...
                                                        <div
                                                            ...
                                                            <input name="primerApellido" type="imput" class="form-control"
                                                                id="apellido" placeholder="..."
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <select name="otroDocNombre"
                                                                        ...
                                                                        <option value="libretaEmbarque">Libreta de Embarque
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input" type="radio"
                                                                    ...
                                                                    value="Primera Vez">
                                                                <label for="estado1" class="custom-control-label">Primera
                                                                    Vez</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input" type="radio"
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label for="estado3" class="custom-control-label">Sol.
                                                                    Anteriores</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="display: inline-block; float: right;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="credencial" type="imput" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6"
                                                                    ...
                                                                    <select name="grado_id" class="form-control select2"
                                                ...
                                                <div class="card-footer">
                                                    ...
                                                    <div class="col-md-6" style="float: right;">
                                                        <button type="button" id="cerrarForm" class="btn btn-block btn-outline-primary">Cerrar</button>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <form method="GET"
                                                    ...
                                                    <button class="btn btn-xs btn-success"
                                                        onclick="return confirm('¿Esta seguro que desea cambiar el estado del postulante a Activo?')"><i
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#mostrarNuevoIngreso').click(function() {
                $('#ingreso').slideToggle("fast");
            });
        });
        $(document).ready(function() {
