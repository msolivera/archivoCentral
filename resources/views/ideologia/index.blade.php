          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$ideologia->id}}</td>
                  <td>{{$ideologia->nombre}}</td>
                  <td>
                   
                  <a href="ideologia/edit/{{$ideologia->id}}" class="btn btn-xs btn-info"><i class="fa fa-light fa-pen"></i></a>  
                  <form method="POST" action="{{route('ideologia.destroy',$ideologia->id)}}" style="display: inline"> {{ csrf_field() }} {{method_field('DELETE')}}
...
<div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <form method="POST" action="{{route('ideologia.store')}}">
    {{ csrf_field() }}
