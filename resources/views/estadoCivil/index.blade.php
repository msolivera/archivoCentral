            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="estadoCivil/edit/{{$estadoCivil->id}}" class="btn btn-xs btn-info"><i class="fa fa-light fa-pen"></i></a>  
                  <form method="POST" action="{{route('estadoCivil.destroy',$estadoCivil->id)}}" style="display: inline"> {{ csrf_field() }} {{method_field('DELETE')}}
