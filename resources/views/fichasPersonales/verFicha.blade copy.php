        ...
        <div class="card card-primary">
          ...
          <div class="card-body box-profile">
            ...
            <ul class="list-group list-group-flush">
              ...
              <div class="col-md-4" style= "float: right; display: inline-block;">
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                  <b>Credencial Civica</b> <a class="float-right">{{$fichaPer->credencial}}</a>
                </li>
              </div>
              <div class="col-md-4" style= "float: right; display: inline-block;">
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                  <b>Correo electronico</b> <a class="float-right">{{$fichaPer->correoElectronico}}</a>
                </li>
                <li class="list-group-item">
                  <b>Fecha de defuncion</b> <a class="float-right">{{$fichaPer->fechaDef}}</a>
                </li>
              </div>
            </ul>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="militar">
                <div class="container row">
                  <div class="col-sm-6">
                    ...
                    <p class="text-muted">{{$fichaPer->fuerza->nombre}}</p>
                    <hr>
                    <strong>Situacion: </strong>
                    <p class="text-muted">{{$fichaPer->situacion->nombre}}</p>
                    <hr>
                  ...
                  <div class="col-sm-6">
                    <strong>Grado: </strong>
                    <p class="text-muted">{{$fichaPer->grado->nombre}}</p>
                    <hr>
                    <strong>Estado de ingreso:</strong>
                    <p class="text-muted">{{$fichaPer->estadoIngreso}}</p>
                    <hr>
                    <strong>Paquete de ingreso Nro.:</strong>
                    <p class="text-muted">{{$fichaPer->numeroPaquete}}</p>
                  </div>
                 </div>
              ...
              <div class="tab-pane" id="ubicacion">
                <div class="container row">
                  <div class="col-sm-6">
                    <strong>Pais: </strong>
                    <p class="text-muted">{{$fichaPer->pais->nombre}}</p>                   
                    <hr>
                    <strong>Departamento: </strong>
                    <p class="text-muted">{{$fichaPer->departamento->nombre}}</p>
                    <hr> 
                    <strong>Ciudad/barrio: </strong>
                    <p class="text-muted">{{$fichaPer->ciudad->nombre}}</p>
                  </div>
                  <div class="col-sm-6">
                    ...
                    <p class="text-muted">{{$fichaPer->seccionalPolicial}}</p>
                    <hr>
                  </div>
                 </div>
              </div>
